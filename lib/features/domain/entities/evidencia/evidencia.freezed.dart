...
mixin _$Evidencia {
 ...
 int get eviId; int get visitaId; String? get eviTipo; String? get eviObservaciones; String? get eviArchivoUrl;@JsonKey(ignore: true) DateTime? get eviFechaCreacion;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eviId,visitaId,eviTipo,eviObservaciones,eviArchivoUrl,eviFechaCreacion);

@override
String toString() {
  return 'Evidencia(eviId: $eviId, visitaId: $visitaId, eviTipo: $eviTipo, eviObservaciones: $eviObservaciones, eviArchivoUrl: $eviArchivoUrl, eviFechaCreacion: $eviFechaCreacion)';
}
...
@useResult
$Res call({
 int eviId, int visitaId, String? eviTipo, String? eviObservaciones, String? eviArchivoUrl,@JsonKey(ignore: true) DateTime? eviFechaCreacion
});
...
/// Create a copy of Evidencia
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? eviId = null,Object? visitaId = null,Object? eviTipo = freezed,Object? eviObservaciones = freezed,Object? eviArchivoUrl = freezed,Object? eviFechaCreacion = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int eviId,  int visitaId,  String? eviTipo,  String? eviObservaciones,  String? eviArchivoUrl, @JsonKey(ignore: true)  DateTime? eviFechaCreacion)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Evidencia() when $default != null:
return $default(_that.eviId,_that.visitaId,_that.eviTipo,_that.eviObservaciones,_that.eviArchivoUrl,_that.eviFechaCreacion);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int eviId,  int visitaId,  String? eviTipo,  String? eviObservaciones,  String? eviArchivoUrl, @JsonKey(ignore: true)  DateTime? eviFechaCreacion)  $default,) {final _that = this;
switch (_that) {
case _Evidencia():
return $default(_that.eviId,_that.visitaId,_that.eviTipo,_that.eviObservaciones,_that.eviArchivoUrl,_that.eviFechaCreacion);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int eviId,  int visitaId,  String? eviTipo,  String? eviObservaciones,  String? eviArchivoUrl, @JsonKey(ignore: true)  DateTime? eviFechaCreacion)?  $default,) {final _that = this;
switch (_that) {
case _Evidencia() when $default != null:
return $default(_that.eviId,_that.visitaId,_that.eviTipo,_that.eviObservaciones,_that.eviArchivoUrl,_that.eviFechaCreacion);case _:
  return null;
...
class _Evidencia implements Evidencia {
  const _Evidencia({required this.eviId, required this.visitaId, required this.eviTipo, required this.eviObservaciones, required this.eviArchivoUrl, @JsonKey(ignore: true) this.eviFechaCreacion});
...
/// Create a copy of Evidencia
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eviId = null,Object? visitaId = null,Object? eviTipo = freezed,Object? eviObservaciones = freezed,Object? eviArchivoUrl = freezed,Object? eviFechaCreacion = freezed,}) {
