...
@override
String toString() {
  return 'RutaDto(rutId: $rutId, venId: $venId, supId: $supId, rutNombre: $rutNombre, rutComentario: $rutComentario, rutFechaEjecucion: $rutFechaEjecucion, nombreVendedor: $nombreVendedor, nombreSupervisor: $nombreSupervisor)';
}
...
/// @nodoc
abstract mixin class $RutaDtoCopyWith<$Res>  {
  factory $RutaDtoCopyWith(RutaDto value, $Res Function(RutaDto) _then) = _$RutaDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RutaDtoCopyWithImpl<$Res>
    implements $RutaDtoCopyWith<$Res> {
  _$RutaDtoCopyWithImpl(this._self, this._then);

  final RutaDto _self;
  final $Res Function(RutaDto) _then;
...
/// Adds pattern-matching-related methods to [RutaDto].
extension RutaDtoPatterns on RutaDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RutaDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RutaDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RutaDto value)  $default,){
final _that = this;
switch (_that) {
case _RutaDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RutaDto value)?  $default,){
final _that = this;
switch (_that) {
case _RutaDto() when $default != null:
return $default(_that);case _:
...
class _RutaDto implements RutaDto {
  const _RutaDto({required this.rutId, required this.venId, required this.supId, required this.rutNombre, required this.rutComentario, required this.rutFechaEjecucion, required this.nombreVendedor, required this.nombreSupervisor});
  factory _RutaDto.fromJson(Map<String, dynamic> json) => _$RutaDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$RutaDtoCopyWith<_RutaDto> get copyWith => __$RutaDtoCopyWithImpl<_RutaDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RutaDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RutaDto&&(identical(other.rutId, rutId) || other.rutId == rutId)&&(identical(other.venId, venId) || other.venId == venId)&&(identical(other.supId, supId) || other.supId == supId)&&(identical(other.rutNombre, rutNombre) || other.rutNombre == rutNombre)&&(identical(other.rutComentario, rutComentario) || other.rutComentario == rutComentario)&&(identical(other.rutFechaEjecucion, rutFechaEjecucion) || other.rutFechaEjecucion == rutFechaEjecucion)&&(identical(other.nombreVendedor, nombreVendedor) || other.nombreVendedor == nombreVendedor)&&(identical(other.nombreSupervisor, nombreSupervisor) || other.nombreSupervisor == nombreSupervisor));
}
...
/// @nodoc
abstract mixin class _$RutaDtoCopyWith<$Res> implements $RutaDtoCopyWith<$Res> {
  factory _$RutaDtoCopyWith(_RutaDto value, $Res Function(_RutaDto) _then) = __$RutaDtoCopyWithImpl;
@override @useResult
$Res call({
 int rutId, int venId, int supId, String rutNombre, String rutComentario, DateTime rutFechaEjecucion, String? nombreVendedor, String? nombreSupervisor
});
...
/// @nodoc
class __$RutaDtoCopyWithImpl<$Res>
    implements _$RutaDtoCopyWith<$Res> {
  __$RutaDtoCopyWithImpl(this._self, this._then);

  final _RutaDto _self;
  final $Res Function(_RutaDto) _then;
