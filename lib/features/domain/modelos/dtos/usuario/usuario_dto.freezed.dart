...
mixin _$UsuarioDto {
 ...
 int get usrId; dynamic get token; String get usrNombreCompleto; String? get usrCorreo; String? get usrTelefono; String? get usrNitEmpleado; String? get usrCarnetIdentidad; String? get usrUsuarioLog; String? get usrContrasenaLog; bool get usrEstadoDel; List<String> get roles; int? get vendedorId; int? get supervisorId; bool get esAdministrador; bool get esSupervisor; bool get esVendedor;
...
@useResult
$Res call({
 int usrId, dynamic token, String usrNombreCompleto, String? usrCorreo, String? usrTelefono, String? usrNitEmpleado, String? usrCarnetIdentidad, String? usrUsuarioLog, String? usrContrasenaLog, bool usrEstadoDel, List<String> roles, int? vendedorId, int? supervisorId, bool esAdministrador, bool esSupervisor, bool esVendedor
});
...
as List<String>,vendedorId: freezed == vendedorId ? _self.vendedorId : vendedorId // ignore: cast_nullable_to_non_nullable
...
class _UsuarioDto implements UsuarioDto {
  const _UsuarioDto({required this.usrId, this.token = "", required this.usrNombreCompleto, required this.usrCorreo, required this.usrTelefono, required this.usrNitEmpleado, required this.usrCarnetIdentidad, required this.usrUsuarioLog, required this.usrContrasenaLog, required this.usrEstadoDel, required final  List<String> roles, required this.vendedorId, required this.supervisorId, required this.esAdministrador, required this.esSupervisor, required this.esVendedor}): _roles = roles;
