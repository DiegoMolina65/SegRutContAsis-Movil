...
class VisitaPorRutaView extends ConsumerWidget {
  ...
  // Mostrar Dialogo y marcar llegada
  void _confirmarYMarcarLlegada(
    ...
    final bool? resultado = await showDialog<bool>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            '¿Está seguro de realizar la marcación de llegada para la visita a ${visita.nombreCliente}?',
          ),
          actions: <Widget>[
            TextButton(
    ...
    // Si el usuario confirma, ejecutar la marcación
    if (resultado == true) {
      await notificador.marcarLlegada(visita);
    }
  }
